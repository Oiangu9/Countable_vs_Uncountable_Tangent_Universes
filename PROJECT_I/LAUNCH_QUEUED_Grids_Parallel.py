...
if __name__ == "__main__":
    ...
    Expected arguments:
    -------------------
    - simulation QUEUE file path
    - number of QUEUE elements to run in parallel processes simultaneously
    (note that each queue element will itself generate a pool of parallel workers as well)
    '''
    ...
    def run_coordinator_and_return(arguments):
        ...
        os.system(
            "python LAUNCH_KA_GRID_for_Scenario_Parallel.py "+arguments[0]+" "+arguments[1]+" "+\
